...
$config = array(
    'xdmod-sp' => array(
        'saml:SP',
        'host'=> '192.168.0.125:4443',
        'entityID' => 'https://192.168.0.125:4443/simplesaml/module.php/saml/sp/metadata.php/xdmod-sp',
    ...
    'dex'=> array(
        ...
        'auth_endpoint' => 'https://192.168.0.125:5554',
        'api_endpoint' => 'https://ondemand:5554',
        'key' => 'localhost',
        'secret' => '334389048b872a533002b34d73f8c29fd09efc50',
        'scope' => 'openid email profile',
        'response_type' => 'code',
        'redirect_uri' => 'https://192.168.0.125:4443/simplesaml/module.php/authoidcoauth2/linkback.php',
        'verify_ssl' => 0
    ),
    'admin' => array(
