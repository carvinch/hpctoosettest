...
then
    ...
    if [[ -n "$tables" ]]; then
        ...
        #------------------------
        sed -i 's%domains = ""%domains = "https://192.168.0.125:3443"%g' /etc/xdmod/portal_settings.ini
        ...
        sudo -u xdmod xdmod-ondemand-ingestor -r ondemand -u https://192.168.0.125:3443 -d /scratch/ondemand/logs
        sudo -u xdmod xdmod-ingestor
        sudo -u xdmod xdmod-ondemand-ingestor -r ondemand -u https://192.168.0.125:3443 -d /scratch/ondemand/logs
